...
if __name__ == '__main__':
    ...
    parser.add_argument('--fusion_module_path', default='checkpoints/checkpoint-714.pth', type=str,
    ...
    parser.add_argument('--save_preds_path', default='./pred_maps_trible_2', type=str,
                        help='Save predicts results path.')
