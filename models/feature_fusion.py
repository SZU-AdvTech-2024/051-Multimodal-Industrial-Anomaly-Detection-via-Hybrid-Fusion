...
class FeatureFusionBlock(nn.Module):
    def __init__(self, xyz_dim, rgb_dim, mlp_ratio=4.,pretrain_path=None):
        super().__init__()
    ...
    def load_pretrain(self,pretrain_path):
        ...
        incompatible = self.load_state_dict(ckpt['model'], strict=False)
        print('[FeatureFusionBlock] Loading pretrain:', incompatible)
